    ...
    for (let videoUrl of videoUrls) {
        if (videoUrl.includes("/user/")) {
            ...
            try {
                ...
                await autoScroll(page); //It can be better and it should depend on connection (if don't get all links redo with 100 or less or try to improve if your connection is a good one)
